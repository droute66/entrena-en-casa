  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-chalk/90 backdrop-blur border-b-2 border-ink">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 min-h-16 py-2 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 sm:gap-4">
          <button
            type="button"
            onClick={goHome}
          ...
          <div className="w-full sm:w-auto flex items-center justify-center sm:justify-end gap-2 sm:gap-3 flex-wrap min-w-0">
            <button
              type="button"
